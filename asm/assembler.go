...
// because some instructions such as RJUMP use relative jumps. Thus the address part of the RJUMP depends on
// where the RJUMP instruction is assembled. If you don't care about the address, just set the address to zero.
